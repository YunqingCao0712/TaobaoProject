...
def click_status(index_: int) -> None:
    ...
    if index_ == -1:
        ...
        status_ = select_filter_.find_elements_by_xpath('//ul[@class="condition"]')[3].find_elements_by_tag_name("em")  # Checked
...
categories = select_filter.find_elements_by_xpath('//ul[@class="condition"]')[:3]
